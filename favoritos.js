document.addEventListener('DOMContentLoaded', () => {
    ...
    function mostrarDetalhesFilme(filmeId) {
      // Aqui você pode adicionar código para mostrar detalhes do filme
      // Por exemplo, abrir uma nova página com detalhes do filme
      window.open(`detalhes.html?filmeId=${filmeId}`, '_blank');
    }
